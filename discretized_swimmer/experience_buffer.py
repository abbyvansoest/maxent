...
class ExperienceBuffer:
    ...
    def normalize(self):
        ...
        for i in range(swimmer_utils.state_dim):
    ...
    def get_discrete_distribution(self):
        ...
        for obs in self.buffer:
            ...
            p[tuple(swimmer_utils.discretize_state(obs))] += 1
    ...
    def get_discrete_distribution_2d(self):
        ...
        p_2d = np.zeros(shape=(swimmer_utils.num_states_2d))
        for obs in self.buffer:
            # discritize obs, add to distribution tabulation.
            p_2d[tuple(swimmer_utils.discretize_state_2d(obs))] += 1
