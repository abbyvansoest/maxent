# Soft-Actor Critic ApproxPlan oracle for Humanoid environment.
    ...
    def test_agent_random(self, T,  n=10):
        ...
        for j in range(n):
            ...
            while not(d or (ep_len == T)):
                ...
                if p_xy[tuple(humanoid_utils.discretize_state_2d(o, self.test_env))]  == 0:
...
if __name__ == '__main__':
    ...
    sac1 = HumanoidSoftActorCritic(lambda : gym.make(args.env), 
    ...
    sac2 = HumanoidSoftActorCritic(lambda : gym.make(args.env), 
        actor_critic=core.mlp_actor_critic, 
        seed=args.seed, gamma=args.gamma, 
        ac_kwargs=dict(hidden_sizes=[args.hid]*args.l),
        logger_kwargs=logger_kwargs)
