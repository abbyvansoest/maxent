...
class AntSoftActorCritic:
    ...
    def test_agent(self, T, n=10, initial_state=[], normalization_factors=[], 
...
if __name__ == '__main__':
    ...
    sac1 = AntSoftActorCritic(lambda : gym.make(args.env), 
    ...
    sac2 = AntSoftActorCritic(lambda : gym.make(args.env), 
        actor_critic=core.mlp_actor_critic, 
        seed=args.seed, gamma=args.gamma, 
        ac_kwargs=dict(hidden_sizes=[args.hid]*args.l),
        logger_kwargs=logger_kwargs)
