...
def make_plots(all_logdirs, legend=None, xaxis=None, values=None, count=False,  
    ...
    if not os.path.exists('explore/figs'):
        os.makedirs('explore/figs')
    plt.savefig('explore/figs/' + fig_name)
...
def main():
    ...
    parser.add_argument('--fig_name', type=str, default='test')
    ...
    make_plots(args.logdir, args.legend, args.xaxis, args.value, args.count, 
               ...
               estimator=args.est, fig_name=args.fig_name)
